...
- **[FlexDoc: Parameterized Sampling for Diverse Multilingual Synthetic Documents for Training Document Understanding Models](https://aclanthology.org/2025.emnlp-industry.105.pdf)**.
<span style="font-size:13px; background:#eaf4ff; color:#0056b3; padding:2px 6px; margin-left:8px; border-radius:4px;">EMNLP'25</span>
...
- **[Aligning LLMs for Multilingual Consistency in Enterprise Applications](https://aclanthology.org/2025.emnlp-industry.9/)**.
<span style="font-size:13px; background:#eaf4ff; color:#0056b3; padding:2px 6px; margin-left:8px; border-radius:4px;">EMNLP'25</span>
...
- **[Towards Robust Continual Test-Time Adaptation via Neighbor Filtration](https://dl.acm.org/doi/10.1145/3746252.3760858)**.
<span style="font-size:13px; background:#eaf4ff; color:#0056b3; padding:2px 6px; margin-left:8px; border-radius:4px;">CIKM'25</span>
Taki Hasan Rafi, Amit Agarwal, **Hitesh Laxmichand Patel**, Dong-Kyu Chae

- **[Who's Asking? Investigating Bias Through the Lens of Disability-Framed Queries in LLMs](https://openaccess.thecvf.com/content/ICCV2025W/CV4A11y/papers/Hari_Whos_Asking_Investigating_Bias_Through_the_Lens_of_Disability-Framed_Queries_ICCVW_2025_paper.pdf)**.
<span style="font-size:13px; background:#eaf4ff; color:#0056b3; padding:2px 6px; margin-left:8px; border-radius:4px;">ICCV'25</span>  
...
<span style="font-size:13px; background:#eaf4ff; color:#0056b3; padding:2px 6px; margin-left:8px; border-radius:4px;">Under Review</span> Eunsu Kim, Haneul Yoo, Guijin Son, **Hitesh Laxmichand Patel**, Amit Agarwal, Alice Oh
...
- **[SpeechWeave: Diverse Multilingual Synthetic Text & Audio Data Generation Pipeline for Training Text to Speech Models](https://aclanthology.org/2025.acl-industry.51/)**.
<span style="font-size:13px; background:#eaf4ff; color:#0056b3; padding:2px 6px; margin-left:8px; border-radius:4px;">ACL'25</span>  
...
<span style="font-size:13px; background:#eaf4ff; color:#0056b3; padding:2px 6px; margin-left:8px; border-radius:4px;">IEEE'25</span>  
...
<span style="font-size:13px; background:#eaf4ff; color:#0056b3; padding:2px 6px; margin-left:8px; border-radius:4px;">IEEE'24</span>  
...
<span style="font-size:13px; background:#eaf4ff; color:#0056b3; padding:2px 6px; margin-left:8px; border-radius:4px;">Springer'24</span> Priyaranjan Pattnayak, **Hitesh Laxmichand Patel**, Bhargava Kumar, Amit Agarwal, Ishan Banerjee, Srikant Panda, Tejaswini Kumar
